...
export const config = {
  ...
  MONGODB_URL:
    process.env.MONGODB_URL || "mongodb://localhost:27017/betterShop",
  ...
  OTP_EXPIRY_MS: process.env.OTP_EXPIRY_MS || 300000, // 5 minutes
  DEFAOULT_OTP_LENGTH: process.env.DEFAOULT_OTP_LENGTH || 6 // default length
};
